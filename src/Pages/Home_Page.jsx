    ...
    <main className="scroll-smooth">
      <>
        ...
        <div className="relative z-10">
          <button
            onClick={scrollToTop}
            className="fixed flex items-center justify-center w-8 h-8 rounded-lg md:w-10 md:h-10 bottom-8 right-5 bg-main-color lg:right-2 md:right-6 md:bottom-6 lg:bottom-6"
          >
