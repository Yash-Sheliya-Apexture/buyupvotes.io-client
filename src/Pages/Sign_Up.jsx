...
const Sign_Up = () => {
  ...
  const [lastName, setLastName] = useState(""); // Add sta
  // te for lastName
          ...
          <div className="lg:w-[30%] h-auto bg-white rounded-small lg:p-6 p-4 pb-10">
            ...
            <form onSubmit={handleSubmit} className="lg:space-y-4 space-y-3">
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  onClick={() => toggleAllPasswordVisibility("password")}
                  className="absolute text-gray-600 right-3 top-4"
                >
                  {showPasswords.all ? <FaEye /> : <FaEyeSlash />}
                </button>
                {errors.password && (
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  onClick={() => toggleAllPasswordVisibility("confirmPassword")}
                  className="absolute text-gray-600 right-3 top-4"
                >
                  {showPasswords.all ? <FaEye /> : <FaEyeSlash />}
                </button>
