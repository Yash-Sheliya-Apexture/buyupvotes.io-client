...
// const Header = () => {
//     const location = useLocation();
//     const { user, loading, logout } = useAuth();  // Get logout function
//     const [showMenu, setShowMenu] = useState(false);
//     const isHomePage = location.pathname === "/";
//     const [isSticky, setIsSticky] = useState(false);
...
//                                             Dashboard
//                                         </Link>
//                                         <button onClick={logout} className="px-4 py-1 text-lg font-medium transition rounded-full lg:px-0 text-main-color border-main-color lg:block">Logout</button>
//                                     </>
...
//           </svg>
//           <Link
//             to={user ? "/dashboard/pricing" : "/pricing"}
//             className="block text-lg font-normal transition-all duration-200 ease-linear font-BasierSquare text-sub-color hover:text-main-color"
//             onClick={toggleMenu}
//           >
//             Pricing
...
//           </svg>
//           <Link
//             to={user ? "/dashboard/contactus" : "/contact-us"}
//             className="block text-lg font-normal transition-all duration-200 ease-linear font-BasierSquare text-sub-color hover:text-main-color"
//             onClick={toggleMenu}
//           >
//             Contact
...
//                     <button
//                       onClick={logout}
//                       className="px-4 py-1 text-lg font-medium transition rounded-full lg:px-0 text-main-color border-main-color lg:block"
//                     >
//                       Logout
//                     </button>
//                   </>
