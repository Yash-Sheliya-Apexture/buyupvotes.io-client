...
const Header = () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      // You can adjust this breakpoint (768px) as needed for tablet screens
    ...
    handleResize(); // Call it initially to check the current size
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 left-0 w-72 bg-white  h-full border-r border-gray-300/50 shadow-main transition-transform duration-300 ease-in-out z-40 ${
