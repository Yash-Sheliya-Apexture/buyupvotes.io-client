    ...
    <>
      <section className="Blog-data">
        <div className="container mx-auto">
          ...
          {!isHomePage && (
            <div className="bg-white my-5 lg:my-0 lg:mt-0">
              <div className="flex flex-col justify-between lg:flex-row lg:items-center md:gap-4 gap-0">
                <h1 className="font-medium text-sub-color lg:text-base text-medium w-fit">
                  Interested in guest posting on our blog?
                  <span className="font-medium underline cursor-pointer text-main-color underline-offset-1">
                    <Link to="/contact-us">contact us</Link>
                  </span>{" "}
                ...
                {/* Dropdown Blog */}
                <div className="flex flex-col md:flex-row md:items-center py-2 lg:w-60 gap-2">
                  <span className="text-nowrap text-sub-color font-medium mb:2 md:mb-0">
                    Sort By:
                  </span>
                  <Dropdown
                    type="text"
