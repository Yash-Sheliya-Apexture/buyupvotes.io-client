...
import char from "../../assets/Images/character_1.png";

const RabbitAccount = () => {
  return (
    <div className="container mx-auto flex flex-col justify-center items-center my-10 relative">
      <h1 className="text-[40px] text-[#2D2624] font-bold mb-6">
        Coming Soon!
      </h1>
      <p className="text-[#2D2624] font-medium text-center leading-9">
        We are currently working hard on this page. <br /> If you have any
      ...
      <div className="mt-10">
        ...
        >
          ...
          ></path>
          <path fill="#FF5700" d="M85.279 71h-14.4v199.5h14.4V71z"></path>
          <path
            fill="#fff"
          ...
          <path
            ...
            opacity="0.48"
          ></path>
          <path fill="#FF5700" d="M188.179 244h-70v18.2h70V244z"></path>
          <path
            fill="#fff"
        ...
        <img src={char} alt="char_1"  className="absolute top-44 right-96 h-56"/>
      </div>
    </div>
  );
};

export default RabbitAccount;
