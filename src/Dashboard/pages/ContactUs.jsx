...
const ContactUs = () => {
  const breadcrumbs = [
    ...
    { label: "Contact Us" }, // No link for the current page
  ];
      ...
      <div className="flex h-screen my-10 bg-white">
        ...
        <div className="relative w-1/2 overflow-hidden rounded-xlarge">
          ...
          <div className="absolute -bottom-20 z-20 flex items-center justify-center h-full px-6">
            <h1 className="text-white text-[60px] font-black text-start leading-[80px]">
              Looking to <br />
        ...
        <div className="w-1/2 flex flex-col items-center justify-center">
          <div className="text-center flex items-center border-b py-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <a href="#" className="text-sub-color hover:underline ml-4">
                WhatsApp
              </a>
            </div>
          </div>
          ...
          <div className="w-full max-w-md">
            ...
            <form className="space-y-3">
              ...
              <div>
                <input
                  className="w-full px-4 py-2 border border-gray-300 hover:border-black transition-all duration-150 ease-in rounded-full"
                  id="subject"
                  type="text"
                  placeholder="Subject"
                />
              ...
              <div>
                <textarea
                  className="w-full border border-gray-300 hover:border-black transition-all duration-150 ease-in rounded-small resize-none"
                  id="message"
                  rows="8"
                  cols="20"
