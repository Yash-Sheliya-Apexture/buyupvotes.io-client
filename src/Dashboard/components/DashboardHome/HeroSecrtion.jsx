...
// const HeroSection = () => {
//   const { auth } = useAuth(); // Access auth context correctly
//   const { user, loading: authLoading } = auth || {}; // Handle auth being potentially null
//   const token = TokenService.getToken();

//   // It's crucial to define API_BASE_URL somewhere in your app or env file.
//   // Replace with your actual API base URL.  For example:
//   // const API_BASE_URL = process.env.REACT_APP_API_BASE_URL;
//   // If you don't have it, use a placeholder but remember to replace it.
//   const API_BASE_URL = "YOUR_API_BASE_URL";  //  <------ IMPORTANT:  REPLACE THIS!

//   const { currentBalance, loading: balanceLoading, error } = useCurrentBalance(
//     API_BASE_URL,
//     token
//   );
