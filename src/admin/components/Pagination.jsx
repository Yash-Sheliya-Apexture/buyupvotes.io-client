      ...
      <ul className="flex justify-center space-x-2 items-center">
        <li>
          <button
            ...
            className={`py-2 px-4 rounded-md bg-white text-gray-700 hover:bg-gray-100 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-200 transition-colors duration-200 ${currentPage === 1 ? "opacity-50 cursor-not-allowed" : ""}`}
          >
          ...
          <li key={index}>
            {page === "..." ? (
              ...
              <button
                ...
                className={`py-2 px-4 rounded-md ${currentPage === page ? "bg-blue-500 text-white" : "bg-white text-gray-700 hover:bg-gray-100 border border-gray-200"} focus:outline-none focus:ring-2 focus:ring-blue-200 transition-colors duration-200`}
              >
                {page}
              </button>
            )}
        ...
        <li>
          <button
            ...
            className={`py-2 px-4 rounded-md bg-white text-gray-700 hover:bg-gray-100 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-200 transition-colors duration-200 ${currentPage === pageNumbers.length ? "opacity-50 cursor-not-allowed" : ""}`}
          >
            Next
