          ...
          {visiblePageNumbers().map((page, index) => (
            <li key={index}>
              {page === "..." ? (
                ...
                <button
                  onClick={() => scrollToTopAndPaginate(page)}
                  className={`py-2 px-4 rounded-md ${currentPage === page ? "bg-light-orange text-white" : "bg-white text-gray-700 hover:bg-gray-100 border border-gray-200"} transition-colors duration-200`}
                >
                  {page}
                </button>
              )}
