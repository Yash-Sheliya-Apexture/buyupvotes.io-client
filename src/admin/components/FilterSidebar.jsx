...
//         isOpen ? "translate-x-0" : "translate-x-full -right-4"
//       } z-50`}
//       ref={sidebarRef}
//     >
...
//             onClick={onClose} // This is the problematic line
//             initial={{ opacity: 0 }}
//             animate={{ opacity: 1 }}
//             exit={{ opacity: 0 }}
...
//       <motion.div
//         className="fixed m-3 top-0 right-0 h-[calc(100%-24px)] w-96 border rounded-xl bg-white z-50"
//         ref={sidebarRef}
